...
int32_t ipu_dc_map(int32_t ipu_index, int32_t map, int32_t format)
{
    ...
    default:
        printk("Map pointer not support yet!\n");
        return -1;
    }
...
void ipu_dc_microcode_config(int32_t ipu_index, dc_microcode_t microcode)
{
    ...
    default:
        printk("Wrong opcode type of DC!!\n");
        return;
    }
                            ...
                            int32_t address)
{
    ...
    default:
        printk("Wrong DC microcode event!!\n");
        return;
    }
