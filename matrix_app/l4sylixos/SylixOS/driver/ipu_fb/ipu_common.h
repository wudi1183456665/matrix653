...
typedef struct {
    ...
    uint32_t drdy_pol;
    uint32_t data_pol;
    int32_t(*panel_init)(int32_t * arg, uint32_t  clk);
...
typedef struct {
    ...
    uint32_t sl;                                                        /*  sl for interleaved mode     */
                                                                        /*  sly for non-interleaved mode*/
    uint32_t u_offset;
    uint32_t bpp;
    uint32_t so;
    uint32_t ilo;
...
void ipu_mipi_csi2_setup(uint32_t  ipu_index,  uint32_t  csi_width,
                         uint32_t  csi_height, ips_dev_panel_t  *panel);
