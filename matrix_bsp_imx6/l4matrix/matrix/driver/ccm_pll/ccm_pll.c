...
VOID  imx6qCcmPLLInit (VOID)
{
    ...
    writel(0xFFFCFFFF, HW_CCM_CCGR1_ADDR);                              /* disable GPU-CG12,13 ESAI-CG8 */
    ...
    writel(0xFF033FFF, HW_CCM_CCGR5_ADDR);                              /* disable SPDIF-CG7 SSI-CG9,10,11 */
