...
#define GIC_CPU_INTERFACE_REGS_BASE_OFFSET      (0x100) /*  GIC CPU 接口寄存器偏移                      */
/*********************************************************************************************************
  GIC 中断发布器寄存器
...
** 调用模块:
*********************************************************************************************************/
static MX_INLINE GIC_DISTRIBUTOR_REG  *armGicIntDistributorGet (VOID)
{
...
** 调用模块:
*********************************************************************************************************/
static MX_INLINE GIC_CPU_INTERFACE_REGS  *armGicCpuInterfaceGet (VOID)
{
...
** 调用模块:
*********************************************************************************************************/
static MX_INLINE UINT32  armGicIntRegOffsGet (UINT32  uiIrqID)
{
    return  (uiIrqID / 32);
}
/*********************************************************************************************************
...
** 调用模块:
*********************************************************************************************************/
static MX_INLINE UINT32  armGicIntBitOffsGet (UINT32  uiIrqID)
{
    return  (uiIrqID & 0x1F);
}
/*********************************************************************************************************
...
** 调用模块:
*********************************************************************************************************/
static MX_INLINE UINT32  armGicIntBitMaskGet (UINT32  uiIrqID)
{
...
BOOL  armGicIrqIsEnable (UINT32  uiIrqID)
{
    ...
    return  ((read32((addr_t)&pDistributor->uiICENABLERn[uiReg]) & uiMask) ? MX_TRUE : MX_FALSE);
}
/*********************************************************************************************************
...
VOID  armGicInit (VOID)
{
    ...
    armGicEnable(MX_FALSE);                             /*  First disable the distributor.              */
    ...
    armGicEnable(MX_TRUE);                              /*  Now enable the distributor.                 */
}
/*********************************************************************************************************
** 函数名称: armGicCpuInit
...
VOID  armGicCpuInit (BOOL  bPreemption,  UINT32  uiPriority)
{
    ...
    armGicCpuEnable(MX_TRUE);                           /*  Enable signaling the CPU.                   */
}
/*********************************************************************************************************
...
{
    armGicIrqEnable(ulVector, MX_FALSE);

    armGicIrqSecuritySet(ulVector, bSecurity);

    armGicIrqPrioritySet(ulVector, ulPriority);

    armGicIrqTargetSet(ulVector, 0xFF, MX_FALSE);

    armGicIrqTargetSet(ulVector, uiCpuMask, MX_TRUE);

    armGicIrqEnable(ulVector, MX_TRUE);
}
/*********************************************************************************************************
